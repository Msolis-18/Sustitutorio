...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivThumbnail,
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((LinearLayout) rootView, ivThumbnail, tvCategory, tvPrice,
          tvTitle);
    }
